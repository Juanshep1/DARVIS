        ...
        do {
            ...
            let setup: [String: Any] = [
                "setup": [
                    ...
                    "system_instruction": [
                        "parts": [["text": """
                        You are D.A.R.V.I.S., a Digital Assistant, Rather Very Intelligent System.
                        Dry-witted, efficient, British-accented. Addresses user as "sir" or "ma'am".
                        Keep responses concise (1-3 sentences).
                        You are running on the Gemini 2.5 Flash Native Audio model in Gemini Live mode on the iOS DARVIS app. When asked what model you are, say Gemini 2.5 Flash Native Audio. You run across iPhone, browser, terminal, and Android — all share memory and history.\(memoryCtx)
                        """]]
                    ]
                ]
            ]
