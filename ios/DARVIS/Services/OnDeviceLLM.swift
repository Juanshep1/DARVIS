...
class OnDeviceLLM: ObservableObject {
    ...
    func generate(prompt: String, maxTokens: Int = 200) async -> String? {
        ...
        let body: [String: Any] = [
            ...
            "systemInstruction": ["parts": [["text": "You are SPECTRA. Do NOT say your name unless asked. Dry-witted British AI. Running Gemma 4 mode on iOS. Concise. 1-3 sentences."]]],
