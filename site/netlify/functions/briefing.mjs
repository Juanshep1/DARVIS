...
export default async (req) => {
  ...
  const briefingPrompt = `You are S.P.E.C.T.R.A. delivering a comprehensive ${period} briefing. Here is ALL the data you have:
