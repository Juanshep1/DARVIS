...
export default async (req) => {
  ...
  const briefingPrompt = `You are D.A.R.V.I.S. delivering a comprehensive ${period} briefing. Here is ALL the data you have:
